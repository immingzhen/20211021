...
class filter_data{
    ...
    {   qDebug() << "datedatedate"<< Qt::endl;
        ...
        for (int i=0 ; i<old.size();i++){
            qDebug() << "ffsjoidfsjadflojsadfosij6666666666666666"<< Qt::endl;
            ...
            for (int i=0 ; i<d_data.size();i++){
                ...
                qDebug() << "77777777777777777777777777777777777"<< Qt::endl;
...
void MainWindow::plot_map(){
    ...
    *set21 << 15 << 30 <<40;
    ...
    for(int yy = 0; yy < columnnumber; ++yy)
    {
        ...
        qDebug()<<"aaa"<<bbb<<"trygggggggggggggggggg"<<endl;
        qDebug()<<rownumber<<"rownumber"<<endl;
       ...
       for (int yyy = 0; yyy<rownumber; ++yyy)
        {
           ...
           // Second Column
           //ui->twTable->setItem( y , 1 , new QTableWidgetItem( bbb[yyy] + QString::number( yyy ) ) );
        }
    ...
    qDebug()<<*d_data<<"mingzhennnnnnnnn"<<endl;
